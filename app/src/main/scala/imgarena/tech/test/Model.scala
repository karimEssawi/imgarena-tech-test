...
case class PointFlow(match_id: Long, message_id: Long, state_before_serve: StateBeforeServe, serve_outcome: ServeOutcome, pre_serve_event: String, post_serve_event: String)
